...
export default function App() {
  ...
  // The email just used to request a verification code/link — needed so
  // the "check your inbox" screen knows which address to verify a typed
  // code against, since verifyOtp requires the email, not just the code.
